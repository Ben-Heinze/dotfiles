...
6. Unless your user name is `ben`, you'll need to manually change the path from `Exec=/home/ben/scripts/launch-awesome` to `Exec=/home/USER_NAME_HERE/scripts/launch-awesome` by substituting `USER_NAME_HERE` to the user's login name.
